...
export default function DancePath() {
  ...
  return (
    <div>
      ...
      {/* Header */}
      <div className="DancePHead">
      <h1>Dance Path & Dance Styles Honors</h1>
      <div className="headIntro">
        舞蹈是無國界語言！解鎖獨特自我，創造更高境界的專屬舞台！<br></br>
        加入升Level之旅，閃爍魅力！習舞之旅，出發吧!<br></br>
        開拓舞者稱號及榮譽，見證習舞成長之路！</div>
      </div>
      {/* Dance Styles */}
      {styles.map((style) => (
        <div key={style.id} className="dance-style-container">
          <img src={style.image} alt={style.title} width="300" height="300" />
          <div className="text-box">
            <h2>{style.title}</h2>
            <p>{style.description}</p>
            <div className="StyleTag-box" style={{ backgroundColor: style.color }}>
              <div className="StyleTag-row">
